...
namespace DynamicBox.Quest.Tests
{
    ...
    {
        [MenuItem("Quest System/Run All Tests")]
        ...
        [MenuItem("Quest System/Validate Test Setup")]
        ...
        [MenuItem("Quest System/Run Quick Smoke Test")]
        ...
        [MenuItem("Quest System/Open Test Documentation")]
