...
Generic Quest Core provides a complete, extensible framework for creating quest systems in Unity. It's designed to be:
...
2. Copy the `Packages/com.genericquest.core` folder to your project's `Packages/` directory
...
Part of the Generic Quest Core project – A mission to make quest systems accessible and extensible.
